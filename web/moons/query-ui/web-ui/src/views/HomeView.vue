  ...
  <div class="container flex-grow-1">
    ...
    <div class="row m-4">
        ...
        <div class="col-sm-3 col-12">
            <img class="img-fluid" src="/MOONS-logo.jpg" alt="MOONS logo">
        </div>
    </div>
    <div class="row m-4">
        <p class="lead">Scientific Objectives</p>
        <p>
        ...
        <dl class="row">
            <dt class="col-sm-3">Galactic archeology.</dt> 
            <dd class="col-sm-9">
        ...
        <dl class="row">
            <dt class="col-sm-3">The growth of galaxies.</dt>
            <dd class="col-sm-9">
            Tracing the assembly history of galaxies over cosmic time remains a primary goal for observational and theoretical studies of the Universe. Exploiting the large multiplex and wavelength coverage of MOONS will allow for the first time to obtain high quality spectra for a statistically significant number of galaxies (~1 million) at z>1.
            </dd>
        </dl>
        <dl class="row">
            <dt class="col-sm-3">The first galaxies.</dt>
            <dd class="col-sm-9">
            The light from the first galaxies, just a few handred million years after the Big Bang is of great importance to understand the cosmic reionization. The unique combination of the 8m VLT aperture, wide-area coverage, and near-IR spectroscopy offered by MOONS will provide accurate distances, relative veleocities and emission-line diagnositcs for statistical samples of z>7 galaxies.
            </dd>
        </dl>
        <p>
